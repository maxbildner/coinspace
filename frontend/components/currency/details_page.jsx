...
const CURRENCYNAMES = {
	...
	"stellar-lumens": { sym: 'XLM', high: .94, site: 'https://www.stellar.org/', paper: 'https://www.stellar.org/papers/stellar-consensus-protocol.pdf' },
	...
	'0x': { sym: 'ZRX', high: 2.53, site: 'https://0x.org/', paper: 'https://0x.org/pdfs/0x_white_paper.pdf' },
